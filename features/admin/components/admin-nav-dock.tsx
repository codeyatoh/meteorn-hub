...
import { LogOut, ShieldAlertIcon, UsersIcon, GamepadIcon, SlidersIcon, Loader2, AtSign, MailQuestion, Droplets } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/admin/faucet", label: "Faucet", icon: Droplets, matchExact: false },
